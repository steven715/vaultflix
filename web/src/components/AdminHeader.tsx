...
// AdminHeader preserves the original (pre-redesign) header for the admin back
// office, which is explicitly out of scope for the user-facing UX redesign.
export default function AdminHeader({ searchQuery, onSearch, onLogoClick }: AdminHeaderProps) {
